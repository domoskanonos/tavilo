# MAIL AN ALEX – Offene Fragen & Nico-Feedback

_Status: Entwurf vom 26.06.2026_

---

**An:** Alex
**Betreff:** Schlafgeschichten – meine Ansicht & ein paar offene Fragen

---

Hallo Alex,

vielen Dank für deine Nachricht – und danke, dass du dir das Format so
...
das halte ich für kein schlechtes Zeichen bei einem Schlafhörspiel.
„Nicht mehr ganz fesseln" ist für mich quasi das Ziel. Spannung wäre
hier genau falsch.

Trotzdem teile ich deinen Punkt zur Meditation voll und ganz. Wir
wollen ja keine geführte Entspannung, sondern eine Geschichte, die das
Kind begleitet, bis es einfach weg ist.

Damit ich jetzt konkret mit der Konzeption starten kann, hätte ich noch
ein paar Fragen. Ich versuche sie so kurz wie möglich zu halten.

**Inhaltlich**

1. **Folgenstruktur:** Soll jede Folge für sich allein stehen, oder
   siehst du Raum für eine durchgehende Welt / wiederkehrende
   Figuren über mehrere Folgen?
2. **Hauptfigur:** Eine feste Identifikationsfigur (mit Name, die in
   jeder Folge dabei ist) oder wechselnde Figuren von Folge zu Folge?
...
_Abgelegt unter `/docs/02-mail-an-alex-offene-fragen.md`_